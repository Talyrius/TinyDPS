--[[-----------------------------------------------------------------------------------------------------------------------------
	...
	* last updated: December 17nd, 2010
...
---------------------------------------------------------------------------------------------------------------------------------
	...
	local isBoss = { -- LibBossIDs-1.0 r48 (Author: Elsia) http://www.wowace.com/addons/libbossids-1-0
...
---------------------------------------------------------------------------------------------------------------------------------
	...
	tdpsFrame:SetScript('OnEvent', function(self, event)
		...
		if curVer ~= tdps.version and '0.93' ~= tdps.version and '0.931' ~= tdps.version and '0.932' ~= tdps.version and '0.933' ~= tdps.version then
			initialiseSavedVariables()
			echo('Global variables have been reset to version ' .. curVer)
		end

		-- character version mismatch
		if curVer ~= tdpsVersion and '0.93' ~= tdpsVersion and '0.931' ~= tdpsVersion and '0.932' ~= tdpsVersion and '0.933' ~= tdpsVersion then
			initialiseSavedVariablesPerCharacter()
